...
import { Edit3, Trash2, Plus, Box } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fcfcfc] dark:bg-[#0a0a0a] p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          ...
          <Link href="/dashboard/vendor/add-product"> {/* Add Product লিঙ্ক */}
            ...
            <div key={item._id} className="group bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-[2rem] overflow-hidden flex flex-col hover:border-blue-600/40 transition-all duration-500">
              ...
              <div className="p-5 flex-grow">
                ...
                <div className="flex items-center justify-between mb-4">
                   ...
                   <span className="text-[9px] font-bold text-zinc-400 uppercase">Qty: {item.stock || 0}</span>
                </div>

                {/* Actions */}
                <div className="flex items-center gap-2 pt-4 border-t border-zinc-50 dark:border-zinc-800">
                  <Link 
                    href={`/dashboard/vendor/editProduct/${item._id}`} 
                    className="flex-1"
                  >
                    <button className="w-full flex items-center justify-center gap-2 py-2.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 rounded-xl font-black text-[9px] uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all">
                      <Edit3 size={12} /> Edit
                    </button>
                  </Link>
