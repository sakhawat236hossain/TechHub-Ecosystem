      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-600 dark:from-orange-600 dark:to-red-800 rounded-3xl p-8 md:p-12 text-white overflow-hidden relative shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-gray-900 dark:bg-zinc-100 text-white dark:text-gray-900 px-10 py-4 rounded-2xl font-black text-lg shadow-xl hover:shadow-white/10 transition-all"
          >
            Shop Now
          </motion.button>
        </div>
